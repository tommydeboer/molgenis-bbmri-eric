 ...
 * @since 1.0
 */
public class LdifHttpMessageConverter extends BaseHttpMessageConverter<Object>
{
	private static final Logger LOG = LoggerFactory.getLogger(LdifHttpMessageConverter.class);
	 ...
	 */
	public LdifHttpMessageConverter()
	{
		this(false);
	}
	 ...
	 * Construct a new {@code GsonHttpMessageConverter} with a default {@link Gson#Gson() Gson}.
	 */
	public LdifHttpMessageConverter(boolean prettyPrinting)
	{
		super(new MediaType("application", "directory", DEFAULT_CHARSET));
	 ...
	 */
	public LdifHttpMessageConverter(Gson gson)
	{
